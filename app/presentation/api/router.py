...
from app.presentation.api.endpoints.search_article import router as search_article_router
from app.presentation.api.endpoints.submit_article import router as submit_article_router
